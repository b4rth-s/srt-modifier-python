exec(open("SRTfunctions.py").read())
import os

a=input("Chemin du fichier à importer : ")
dt=int(input("Temps de décalage (positif si ST arrive trop tot) = "))
